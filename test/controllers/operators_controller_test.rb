...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference("Operator.count") do
      post operators_url, params: { operator: { cpf: @operator.cpf, data_nascimento: @operator.data_nascimento, matricula: @operator.matricula, nome: @operator.nome, turno: @operator.turno } }
    end
