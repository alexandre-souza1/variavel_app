...
ActiveRecord::Schema[7.1].define(version: 2026_09_23_150000) do
  ...
  create_table "ai_settings", force: :cascade do |t|
    t.string "primary_model", default: "gemini-3.6-flash", null: false
    t.integer "meeting_audio_max_minutes", default: 15, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "checklist_defects", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["checklist_id"], name: "index_checklist_defects_on_checklist_id"
  end
  ...
  create_table "fleet_availability_items", force: :cascade do |t|
    ...
    t.index ["fleet_availability_id", "position"], name: "index_fleet_availability_items_on_unique_available_position", unique: true, where: "(status = 0)"
