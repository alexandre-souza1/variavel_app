...
Os cadastros não são fundidos automaticamente por nome. Matrículas ambíguas precisam de revisão do RH. Há vínculo explícito entre cadastros legados da mesma pessoa (CPF coincidente), com data de promoção e auditoria. Os fechamentos do cadastro de origem permanecem acessíveis pelo link no cadastro de destino. Uma revisão explícita no destino consolida o período pela história cadastrada.
